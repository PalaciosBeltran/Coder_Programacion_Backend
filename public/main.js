...
const compression = require('../controllers/messages.controllers').getCompression();
...
socket.on('message', (data) => {
    ...
    .join("\n");
    const comp = `<strong><span style="color: blue">(Compresión: ${compression})</strong></span><br><br>`
